...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 07, 2024 at 10:46 PM
...
INSERT INTO `artis` (`id_artis`, `nama_artis`, `id_konser`) VALUES
(1, 'NdarBoy Genk', 1),
(2, 'Jumat Gombrong', 1),
(3, 'Karaoke Paripurna', 1),
(4, 'Alan Walker', 2),
(5, 'David Foster', 3),
(6, 'Katharine McPhee', 3),
(7, 'Brian McKnight', 3),
(8, 'Jessie J', 3),
(9, 'Rossa', 3),
(10, 'Josh Groban', 3),
...
(2, 'jerry', 'yeremia.christopher@ti.ukdw.ac.id', '123');
...
--
ALTER TABLE `artis`
  ADD CONSTRAINT `fk_konser` FOREIGN KEY (`id_konser`) REFERENCES `konser_data` (`id_konser`);
